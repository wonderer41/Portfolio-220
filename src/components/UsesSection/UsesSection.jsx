...
const UsesSection = ({ groupName, items = [] }) => {
  return (
    <section className="flex flex-col p-0 lg:px-[15px] ">
      <div className="flex flex-col lg:flex-row justify-between lg:pl-[24px] lg:border-zink-400 lg:border-l lg:gap-20">
        <h2>{groupName}</h2>
