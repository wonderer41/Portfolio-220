...
const SignupWidget = ({ title, content, simulateNetworkRequestTime }) => {
  ...
  return (
    <form className={'flex flex-col p-6 border border-zinc-100 dark:border-zinc-700/40 rounded-2xl w-full lg:w-[398px] h-[196px] gap-x-3'} onSubmit={handleSubmit} autoComplete={'false'}>
