...
const Introduction = ({title, content, socialLinks = []}) => {
    return (
        <div className='introduction flex flex-col gap-6' width={672} height={384}>
            <Image src='/Introduction/profile.jpg' width={64} height={64} className="rounded-full border-2 border-white/90 dark:border-zinc-800/90 shadow-lg" alt='Profile picture'/>
