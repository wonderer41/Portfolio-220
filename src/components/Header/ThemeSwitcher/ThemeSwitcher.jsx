...
const ThemeSwitcher = () => {
  ...
  return (
    <div>
      <button className="flex flex-row justify-center w-12 h-10 px-3 py-2 ring-1 ring-zinc-900/5 dark:ring-zinc-800/90 active:ring-teal-400 dark:active:ring-teal-400 shadow-lg rounded-full dark:bg-zinc-800/90" data-testid="themeSwitcherButton" onClick={toggleTheme}>
        {isDarkMode ? 
